...
const logOperationResults = (
  results: Sync.PushResult[] | Sync.BuildResult[],
  operation: string
): void => {
...
export const logPushResults = (results: Sync.PushResult[]): void => {
  logOperationResults(results, "Pushes");
};

export const logBuildResults = (results: Sync.BuildResult[]): void => {
